...
url_list = []
global dump
mon_to_days = {'01':'31','02':'28','03':'31','04':'30','05':'31','06':'30','07':'31','08':'31','09':'30','10':'31','11':'30','12':'31'}
...
def getFiles(start, end):
  ...
  endList = end.split("-")
  #url="http://archive.routeviews.org/bgpdata/"+startList[0]+"."+startList[1]+"/UPDATES/updates."+startList[0]+startList[1]+startList[2]+".0001.bz2"
  url = "http://archive.routeviews.org/bgpdata/2009.12/UPDATES/"
  download_file(url)
...
if __name__ == '__main__':
  if len(sys.argv)<4:
    print "usage --> python startDate(year-month-day-hour-min-sec) endDate fileName"
    exit(1)
